# Asterix and Double Trouble  --  Replication, Caching, and Fault Tolerance
...
Your goal is to help the Gauls by adding caching, replication, and fault tolerance to the stock bazaar application that were
